    ...
    <View style={s.container}>
      ...
      <View style={s.brandBar}>
        ...
        <TouchableOpacity onPress={() => { if (router.canGoBack()) router.back(); else router.replace('/(tabs)/'); }} style={s.brandClose}>
          <Text style={{ color: '#2C5F6E', fontSize: 18, fontWeight: '600' }}>✕</Text>
        </TouchableOpacity>
      </View>
      <View style={[s.header, { flexDirection: isRTL ? 'row-reverse' : 'row' }]}>
        <Text style={[s.title, { textAlign: isRTL ? 'right' : 'left', writingDirection: isRTL ? 'rtl' : 'ltr' }]}>{t('home.gallery')}</Text>
...
const makeStyles = (isRTL: boolean) => StyleSheet.create({
  ...
  header: { alignItems: 'center', paddingHorizontal: 16, paddingVertical: 14, backgroundColor: Colors.PRIMARY, gap: 10 },
  back: { padding: 4 },
  ...
  brandBar: { flexDirection: isRTL ? 'row-reverse' : 'row', alignItems: 'center', paddingHorizontal: 16, paddingVertical: 12, backgroundColor: '#fff', borderBottomWidth: 1, borderBottomColor: '#EAE0CE' },
  brandTxt: { flex: 1, fontSize: 24, fontWeight: '600', letterSpacing: 0.3, textAlign: 'center' },
  brandClose: { width: 32, alignItems: 'center' },
  title: { flex: 1, color: '#fff', fontSize: 24, fontWeight: '400', letterSpacing: 0.3 },
  count: { color: '#fff', fontSize: 14, fontWeight: '600', letterSpacing: 0.2 },
  ...
  watermarkBox: { position: 'absolute', backgroundColor: 'rgba(0,0,0,0.45)', paddingHorizontal: 10, paddingVertical: 5, borderRadius: 0 },
  ...
  tileMarkBox: { position: 'absolute', backgroundColor: 'rgba(0,0,0,0.45)', paddingHorizontal: 6, paddingVertical: 3, borderRadius: 0 },
