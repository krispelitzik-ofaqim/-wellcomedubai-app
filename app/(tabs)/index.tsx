...
const s = StyleSheet.create({
  ...
  linkRowBig: { flexDirection: 'row-reverse', justifyContent: 'center', gap: 16, marginBottom: 5 },
  linkRowMed: { flexDirection: 'row-reverse', justifyContent: 'center', gap: 12, marginBottom: 3, flexWrap: 'wrap' },
