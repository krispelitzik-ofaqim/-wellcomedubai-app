...
const s = StyleSheet.create({
  ...
  reBanner: { height: 130, marginTop: 22, borderRadius: 0, overflow: 'hidden', backgroundColor: Colors.PRIMARY },
  reOverlay: { flex: 1, backgroundColor: 'rgba(0,0,0,0.5)', paddingHorizontal: 18, justifyContent: 'center', alignItems: 'center' },
  reKicker: { color: Colors.GOLD, fontSize: 10, letterSpacing: 2, fontWeight: '700' },
  mktBanner: { height: 130, marginTop: 1, borderRadius: 0, overflow: 'hidden' },
  mktOverlay: { flex: 1, backgroundColor: 'rgba(60,26,8,0.5)', paddingHorizontal: 18, justifyContent: 'center', alignItems: 'center' },
  bannerAccent: { position: 'absolute', top: 0, left: 0, right: 0, height: 3, zIndex: 10 },
  mktKicker: { color: '#F4D48A', fontSize: 10, letterSpacing: 2.5, fontWeight: '700' },
  mktArrow: { color: 'rgba(255,255,255,0.85)', fontSize: 34, fontWeight: '200', marginHorizontal: 4 },
  reTitle: { color: '#fff', fontSize: 23, fontWeight: '500', letterSpacing: 0.3, marginTop: 6, writingDirection: 'rtl' },
  reSub: { color: 'rgba(255,255,255,0.92)', fontSize: 13, marginTop: 4, writingDirection: 'rtl' },
});
