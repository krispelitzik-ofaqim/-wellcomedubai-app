          ...
          <ImageBackground source={{ uri: HERO_IMAGES[heroIdx] }} style={s.hero}>
            <View style={s.heroOverlay}>
              ...
              <View style={s.heroTop}>
                <Text style={[s.heroTitle, { fontSize: f(26) }]}>ברוכים הבאים ל<Text style={{ color: Colors.GOLD }}>דובאי</Text></Text>
...
const s = StyleSheet.create({
  ...
  linkRowBig: { flexDirection: 'row-reverse', justifyContent: 'center', gap: 16, marginBottom: 6 },
